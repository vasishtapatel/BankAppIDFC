...
function Transfer() {
  ...
  const handleSubmit = (e) => {
    ...
    let response = fetch(
      `/transfer/${state.from}/${state.to}/${state.ifscCode}/${state.amount}/${state.custid1}/${state.custid2}`,
      {
        method: "get",
        headers: {
      ...
      <form className="form" onSubmit={handleSubmit}>
        ...
        <div className="form__item">
          ...
          <input
            ...
            className="input"
            value={state.custid1}
            placeholder="Your custid"
            onChange={(event) =>
              setState({ ...state, custid1: event.target.value })
            }
          />
        </div>
        <div className="form__item">
        ...
        <div className="form__item">
          ...
          <input
            ...
            className="input"
            value={state.custid2}
            placeholder="Receiver Custid"
            onChange={(event) =>
              setState({ ...state, custid2: event.target.value })
            }
          />
        </div>
        <div className="form__item">
